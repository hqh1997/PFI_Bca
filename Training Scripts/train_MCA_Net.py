...
class CustomDataset(Dataset):
    def __init__(self, micro_filepaths, data, macro_file_path):
...
def prepare_data_list(micro_filepaths, data, macro_file_path,  n_classes=4):
    ...
    return CustomDataset(micro_filepaths, data, macro_file_path)
...
if __name__ == '__main__':
    ...
    train_dataset = prepare_data_list(Train_V, info_train, macro_file_path, n_classes=4)
    val_dataset = prepare_data_list(Valid_V, info_val, macro_file_path,  n_classes=4)
    ...
    for epoch in tqdm(range(EPOCH)):
        ...
        for batch_idx, batch_data in enumerate(train_loader):
            ...
            hazards, survs, Y, attention_scores = model(micro, macro)
        ...
        for  batch_idx, val_batch_data in enumerate(val_loader):
            with torch.no_grad():
                ...
                val_hazards, val_survs, val_Y, val_attention_scores = model(val_micro, val_macro)
        ...
        with open('path/to/NCTNet.txt', 'a') as f:
